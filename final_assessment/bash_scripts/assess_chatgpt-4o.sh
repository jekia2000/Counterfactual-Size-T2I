python /data/leuven/370/vsc37045/thesis/final_assessment/generate_images.py \
    --data "/scratch/leuven/370/vsc37045/resource/gpt/dataset/test.json" \
    ...
    --savepath "/scratch/leuven/370/vsc37045/resource/assessments/chatgpt-4o_evaluated.json" \
    --img_folder "/scratch/leuven/370/vsc37045/resource/assessments/chatgpt-4o_evaluated_imgs"
