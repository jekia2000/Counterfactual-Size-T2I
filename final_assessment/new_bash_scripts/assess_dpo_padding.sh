...
#  --savepath "/leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/resource/assessments/${SEED}/dpo_paddinng.json"  \
#  --model_path "/leonardo_work/EUHPC_B22_061/aleksa_files_by_aleksa/downloaded_work/resource/dpo/experiment_padding_left/full_train_run/checkpoint-step112" \
...
python /leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/thesis/final_assessment/text2reward.py \
    --data  "/leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/resource/assessments/${SEED}/dpo_padding.json"  \
    ...
    --img_folder "/leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/resource/assessments/${SEED}/dpo_padding_imgs"
