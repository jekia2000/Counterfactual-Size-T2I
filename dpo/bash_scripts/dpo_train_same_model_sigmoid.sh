#!/bin/bash
python /leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/thesis/dpo/dpo_train.py \
 ...
 --sft_model_path "/leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/resource/gpt/new_sft2/best_model/" \
