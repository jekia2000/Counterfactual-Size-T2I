python /leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/code/evaluator/eval.py \
 --data "/leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/resource/evaluator/combined_images.json" \
 ...
 --img_folder "" \
 --savepath  "/leonardo_work/EUHPC_B25_058/aleksa_files/downloaded_work/resource/evaluator/2/rewards.json" \
